...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|p{11cm}|}
        \hline
        \textbf{STT} & \textbf{Dòng} & \textbf{Địa chỉ IP đích} & \textbf{Thông tin} \\
        \hline
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|c|}
            \hline
            \textbf{STT} & \textbf{Dòng} & \textbf{Time} & \textbf{Địa chỉ IP đích} & \textbf{File} \\
            \hline
...
\begin{itemize}
    ...
    \hline
    \textbf{STT} & \textbf{Dòng} & \textbf{Source} & \textbf{Destination} & \textbf{Source $\rightarrow$ Destination} & \textbf{TCP Flags} \\
    \hline
...
tcp.stream == 6\end{lstlisting}
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
    \hline
    \textbf{STT} & \textbf{Dòng} & \textbf{Source} & \textbf{Destination} & \textbf{TCP Segment Len} & \textbf{TCP Flags} \\
    \hline
